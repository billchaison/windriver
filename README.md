...
![alt text](https://github.com/billchaison/windriver/blob/master/01.png)

![alt text](https://github.com/billchaison/windriver/blob/master/00.png)

If all goes well you should be able to store a byte in the POST port and read it back out.

![alt text](https://github.com/billchaison/windriver/blob/master/02.png)
